        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                onClick={() => navigate('/emotional-support')}
                className="bg-forest-600 text-white px-8 py-4 rounded-full font-semibold hover:bg-forest-700 transform hover:scale-105 transition-all duration-200 flex items-center justify-center space-x-2"
              >
